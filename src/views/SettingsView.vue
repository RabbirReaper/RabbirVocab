        ...
        <div class="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              disabled
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-disabled text-tertiary-color"
            />
          </div>
    ...
    <div class="card">
      ...
      <div class="space-y-4">
        <div>
          ...
          <button class="btn btn-secondary mt-2">更新密碼</button>
        </div>
